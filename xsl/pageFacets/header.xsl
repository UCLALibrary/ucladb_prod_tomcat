...
<a href="http://www.library.ucla.edu/"><img alt="Library Home Page" src="ui/ucladb/images/UCLA-Library-graphic_060314.gif"/></a>
...
<a href="http://www.library.ucla.edu/support/research-help">Ask! a Librarian</a> | 
<span>
<a href="{page:element[@nameId='page.header.help.link']/page:URL}" target="_help">
<xsl:value-of select="page:element[@nameId='page.header.help.link']/page:linkText"/>
</a>&#160;<xsl:value-of select="page:element[@nameId='page.header.help.link']/page:postText"/>
</span> | <a href="http://www.library.ucla.edu/about/want-give-us-feedback">Feedback</a>
            </div>
         </div>
...
<a href="https://ucill.vdxhost.com/zportal/" style="padding-right: 25px;">My ILL Requests</a>
