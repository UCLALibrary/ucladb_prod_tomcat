/* $Revision: 1.1.1.1.10.1 $ $Date: 2012/06/12 14:59:02 $ */
/*
#(c)#=====================================================================
#(c)#
...
function doBookScripts(bibKey,handler)
{
   ...
   scriptElement.setAttribute("src", "https://books.google.com/books?bibkeys=" + escape(document.getElementById(bibKey).value) + "&jscmd=viewapi&callback="+handler);
